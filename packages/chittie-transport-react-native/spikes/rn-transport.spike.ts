...
import { createTransport, createBleTransport, BLE_DEFAULT_CHUNK, toBase64, toByteArray, toHex } from '../src/index.js';
...
console.log('✓ chittie-transport-react-native spike — generic adapter + BLE chunking + base64/byteArray/hex helpers');
